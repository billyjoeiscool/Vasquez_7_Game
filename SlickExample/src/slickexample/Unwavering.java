...
class item1 {
	...
	Image currentImage;
	Shape hitbox;
	Image healthpotion = new Image("res/th.png");
...
class itemwin {
	...
	Image currentImage;
	Shape hitbox;
	Image antidote = new Image("res/Money.png");
...
public class Unwavering extends BasicGameState {
	...
	throws SlickException {
		...
		g.drawString("speed: " + (int)(player.speed *15), camera.cameraX + 15,
				camera.cameraY + 25);
